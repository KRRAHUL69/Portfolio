  ...
  const projects = [
    {
      name: "3D Portfolio",
      description:
        "Web-based platform that showcase my skills, personal projects and work experience.",
      tags: [
        {
          name: "react",
    ...
    },
    {
      name: "Shopify",
      description:
        "Web application that enables users to search for apparels with customized filters & safe transaction portal.",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
